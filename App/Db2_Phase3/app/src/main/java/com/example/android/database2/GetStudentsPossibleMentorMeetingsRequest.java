...
public class GetStudentsPossibleMentorMeetingsRequest extends StringRequest {
    private Map<String, String> args;
    private static Response.ErrorListener err = new Response.ErrorListener()
    {
        @Override
        public void onErrorResponse(VolleyError error) {
            Log.d("GetPMentorMeetings", "Error listener response: " + error.getMessage());
        }
    };

    // Must have url passed in as arg to make use of string resources without using contexts
    public GetStudentsPossibleMentorMeetingsRequest(int sid, String url, Response.Listener<String> listener){
