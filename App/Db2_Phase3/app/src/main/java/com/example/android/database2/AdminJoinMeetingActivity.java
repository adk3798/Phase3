...
public class AdminJoinMeetingActivity extends AppCompatActivity {
    TextView tvHeader;
    Button bJoinMentor;
    Button bLeaveMentor;
    Button bJoinMentee;
    ...
    private static final String TAG = "AdminMeetings";
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    while(jsonResponse.has(Integer.toString(i) + "mid")) {
                        ...
                        TextView meetingTxt = new TextView(AdminJoinMeetingActivity.this);
                        meetingTxt.setText(mname + " " + mdate + " " + mday + " " + mstart + " to " + mend);
                        MeetingCheckbox mch = new MeetingCheckbox(AdminJoinMeetingActivity.this, mid);
                        mentorjoin.add(mch);
                        LinearLayout lrow = new LinearLayout(AdminJoinMeetingActivity.this);
        ...
        RequestQueue mentorjoinqueue = Volley.newRequestQueue(AdminJoinMeetingActivity.this);
        mentorjoinqueue.add(sMMR);

        bMainPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent sReturn = new Intent(AdminJoinMeetingActivity.this, AdminActivity.class);
                sReturn.putExtra("name", name);
                sReturn.putExtra("aid", aid);
                AdminJoinMeetingActivity.this.startActivity(sReturn);
            }
            ...
            public void onClick(View v) {
                for(int i = 0; i < mentorjoin.size(); i++) {
                    if(mentorjoin.get(i).getCheckbox().isChecked()) {
                        ...
                        RequestQueue queue = Volley.newRequestQueue(AdminJoinMeetingActivity.this);
                        queue.add(jmR);
                    }
                }
                Intent sReturn = new Intent(AdminJoinMeetingActivity.this, AdminActivity.class);
        ...
        RequestQueue mentorleavequeue = Volley.newRequestQueue(AdminJoinMeetingActivity.this);
        ...
        RequestQueue menteejoinqueue = Volley.newRequestQueue(AdminJoinMeetingActivity.this);
