...
public class StudentJoinMeetingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    while(jsonResponse.has(Integer.toString(i) + "mid")) {
                        ...
                        TextView meetingTxt = new TextView(StudentJoinMeetingActivity.this);
                        meetingTxt.setText(mname + " " + mdate + " " + mday + " " + mstart + " to " + mend);
                        MeetingCheckbox mch = new MeetingCheckbox(StudentJoinMeetingActivity.this, mid);
                        mentorjoin.add(mch);
                        LinearLayout lrow = new LinearLayout(StudentJoinMeetingActivity.this);
        ...
        RequestQueue mentorjoinqueue = Volley.newRequestQueue(StudentJoinMeetingActivity.this);
        mentorjoinqueue.add(sMMR);

        bMainPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent sReturn = new Intent(StudentJoinMeetingActivity.this, StudentActivity.class);
                sReturn.putExtra("name", name);
                sReturn.putExtra("sid", sid);
                StudentJoinMeetingActivity.this.startActivity(sReturn);
            }
            ...
            public void onClick(View v) {
                for(int i = 0; i < mentorjoin.size(); i++) {
                    if(mentorjoin.get(i).getCheckbox().isChecked()) {
                        ...
                        RequestQueue queue = Volley.newRequestQueue(StudentJoinMeetingActivity.this);
                        queue.add(jmR);
                    }
                }
                Intent sReturn = new Intent(StudentJoinMeetingActivity.this, StudentActivity.class);
        ...
        RequestQueue mentorleavequeue = Volley.newRequestQueue(StudentJoinMeetingActivity.this);
        ...
        RequestQueue menteejoinqueue = Volley.newRequestQueue(StudentJoinMeetingActivity.this);
