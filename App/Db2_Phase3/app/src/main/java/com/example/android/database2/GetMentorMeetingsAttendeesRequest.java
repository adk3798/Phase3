...
public class GetMentorMeetingsAttendeesRequest extends StringRequest {
    ...
    public GetMentorMeetingsAttendeesRequest(int sid, String url, Response.Listener<String> listener){
