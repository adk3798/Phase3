...
public class ParentStudyMaterialsActivity extends AppCompatActivity {
    Button bMainPage;
    TextView tvHeader;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView infoTxt = new TextView(ParentStudyMaterialsActivity.this);
        ...
        tvHeader.setText("Study Materials For " + student_name);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    while(jsonResponse.has(Integer.toString(i) + "mid")) {
                        ...
                        TextView meetingTxt = new TextView(ParentStudyMaterialsActivity.this);
        ...
        RequestQueue queue = Volley.newRequestQueue(ParentStudyMaterialsActivity.this);
        queue.add(sSMR);

        bMainPage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent sReturn = new Intent(ParentStudyMaterialsActivity.this, ParentActivity.class);
                sReturn.putExtra("name", name);
                sReturn.putExtra("pid", pid);
                ParentStudyMaterialsActivity.this.startActivity(sReturn);
            }
