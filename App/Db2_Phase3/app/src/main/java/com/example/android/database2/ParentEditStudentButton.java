...
public class ParentEditStudentButton {
    ...
    public ParentEditStudentButton(final Context context, String text, int student_id, String student_name, int parent_id, String parent_name) {
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent psEditIntent = new Intent(context, ParentEditStudentActivity.class);
