...
public class StudentLoginRequest extends StringRequest {
    ...
    private static Response.ErrorListener err = new Response.ErrorListener()
    {
        ...
        public void onErrorResponse(VolleyError error) {
            Log.d("LoginStudent", "Error listener response: " + error.getMessage());
        }
    };

    // Must have url passed in as arg to make use of string resources without using contexts
    public StudentLoginRequest(String email, String password, String url, Response.Listener<String> listener){
