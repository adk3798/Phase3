...
public class ParentStudyMaterialsButton {
    private Button bt;
    private int sid;
    private String sname;
    private int pid;
    private String pname;
    public ParentStudyMaterialsButton(final Context context, String text, int student_id, String student_name, int parent_id, String parent_name) {
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent psEditIntent = new Intent(context, ParentStudyMaterialsActivity.class);
